...
class ControllerContext:
    ...
    def setup(self, transmode: TransportMode, profile: str, para: int, repeat: int, 
        ...
        with open(self.profile_path, 'r') as f:
            ...
            self.node_resources: Dict[str, int] = self.profile['node_resources']

        self.deploy = DeploymentGenerator(self.profile_path, self.ditto_placement is False, knative = self.knative, fake_node_resources=self.node_resources)
