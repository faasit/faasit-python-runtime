...
class DeploymentGenerator:
    def __init__(self, profile_path: str, random_placement: bool, *, local_placement: bool = False, fake_node_resources: Dict[str, int], knative: bool = False) -> None:
        # load the profile
        ...
        for node in self.node_resources.keys():
            self.node_resources[node] = fake_node_resources
        logging.info(f"Node resources: {self.node_resources}")
